...
public class HealthInterface {
    ...
    private HealthInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                ContextConstants.Features.HEALTH) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link evervolv.health.HealthInterface}
     *
    ...
    public static IHealthInterface getService() {
        ...
        IBinder b = ServiceManager.getService(ContextConstants.HEALTH_INTERFACE);
    ...
    private boolean checkService() {
        if (sService == null) {
            Log.w(TAG, "not connected to HealthInterfaceService");
            return false;
        }
        return true;
    }
