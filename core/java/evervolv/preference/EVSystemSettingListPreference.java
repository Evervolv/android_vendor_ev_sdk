...
public class EVSystemSettingListPreference extends ListPreference {
    ...
    protected boolean persistString(String value) {
        if (shouldPersist()) {
            ...
            EVSettings.System.putString(getContext().getContentResolver(), getKey(), value);
            return true;
        }
        return false;
    }
    ...
    protected String getPersistedString(String defaultReturnValue) {
        ...
        String value = EVSettings.System.getString(getContext().getContentResolver(), getKey());
