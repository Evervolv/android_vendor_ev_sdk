...
public class RemotePreference extends SelfRemovingPreference
    ...
    public static final String ACTION_REFRESH_PREFERENCE =
            "evervolv.intent.action.REFRESH_PREFERENCE";

    public static final String ACTION_UPDATE_PREFERENCE =
            "evervolv.intent.action.UPDATE_PREFERENCE";

    public static final String META_REMOTE_RECEIVER =
            "com.evervolv.settings.summary.receiver";

    public static final String META_REMOTE_KEY =
            "com.evervolv.settings.summary.key";

    public static final String EXTRA_ENABLED = ":pref_enabled";
    public static final String EXTRA_KEY = ":pref_key";
    public static final String EXTRA_SUMMARY = ":pref_summary";
