...
public class StyleInterface {
     ...
     * @see #setAccent
     */
    public static final String ACCENT_DEFAULT = "evervolv";
     ...
     * @hide
     */
    public static final String OVERLAY_DARK_DEFAULT = "com.evervolv.overlay.dark";
     ...
     * @hide
     */
    public static final String OVERLAY_DARK_BLACK = "com.evervolv.overlay.black";
    ...
    public static final String CHANGE_STYLE_SETTINGS_PERMISSION =
            "evervolv.permission.CHANGE_STYLE";
    ...
    private StyleInterface(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                ContextConstants.Features.STYLES) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link evervolv.style.StyleInterface}
     *
    ...
    public static IStyleInterface getService() {
        ...
        IBinder b = ServiceManager.getService(ContextConstants.STYLE_INTERFACE);
