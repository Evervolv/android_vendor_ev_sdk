...
public class LongScreen {
    ...
    public LongScreen(Context context) {
        ...
        mLongScreenAvailable = resources.getBoolean(
                com.evervolv.platform.internal.R.bool.config_haveHigherAspectRatioScreen);
    ...
    public void addApp(String packageName) {
        ...
        EVSettings.System.putString(mContext.getContentResolver(),
                EVSettings.System.LONG_SCREEN_APPS, String.join(",", mApps));
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.LONG_SCREEN_APPS), false, this,
                    UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            String apps = EVSettings.System.getStringForUser(resolver,
                    EVSettings.System.LONG_SCREEN_APPS,
