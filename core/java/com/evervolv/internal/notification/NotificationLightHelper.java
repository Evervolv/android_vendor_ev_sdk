...
package com.evervolv.internal.notification;
...
public final class NotificationLightHelper {
    private static final String TAG = "NotificationLightHelper";
    ...
    public NotificationLightHelper(Context context, LedUpdater ledUpdater) {
        mContext = context;
        ...
        final String[] defaultMapping = res.getStringArray(
                com.evervolv.platform.internal.R.array.notification_light_package_mapping);
    ...
    public boolean isForcedOn(Notification n) {
        if (n.extras != null) {
            return n.extras.getBoolean(NotificationHelper.EXTRA_FORCE_SHOW_LIGHTS, false);
        }
        return false;
    }
    ...
    private int getForcedBrightness(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(NotificationHelper.EXTRA_FORCE_LIGHT_BRIGHTNESS, 0);
        }
        return 0;
    }
    ...
    public int getForcedColor(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(NotificationHelper.EXTRA_FORCE_COLOR, 0);
        }
        return 0;
    }
    ...
    public int getForcedLightOnMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(NotificationHelper.EXTRA_FORCE_LIGHT_ON_MS, -1);
        }
        return -1;
    }
    ...
    public int getForcedLightOffMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(NotificationHelper.EXTRA_FORCE_LIGHT_OFF_MS, -1);
        }
        return -1;
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    ...
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO), false,
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.ZEN_ALLOW_LIGHTS), false, this,
                    UserHandle.USER_ALL);
        ...
        private void update() {
            ...
            mAutoGenerateNotificationColor = EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO,
                    1, UserHandle.USER_CURRENT) != 0;

            // LED default color
            mDefaultNotificationColor = EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR,
                    mDefaultNotificationColor, UserHandle.USER_CURRENT);

            // LED default on MS
            mDefaultNotificationLedOn = EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON,
                    mDefaultNotificationLedOn, UserHandle.USER_CURRENT);

            // LED default off MS
            mDefaultNotificationLedOff = EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF,
            ...
            if (EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE, 0,
                    UserHandle.USER_CURRENT) != 0) {
                parseNotificationPulseCustomValuesString(EVSettings.System.getStringForUser(
                        resolver, EVSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES,
                        UserHandle.USER_CURRENT));
            }

            // Notification lights with screen on
            mScreenOnEnabled = (EVSettings.System.getIntForUser(resolver,
                    EVSettings.System.NOTIFICATION_LIGHT_SCREEN_ON, 0,
                    UserHandle.USER_CURRENT) != 0);

            // Adustable notification LED brightness.
            if (mCanAdjustBrightness) {
                // Normal brightness.
                mNotificationLedBrightnessLevel = EVSettings.System.getIntForUser(resolver,
                        EVSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
                // Brightness in Do Not Disturb mode.
                mNotificationLedBrightnessLevelZen = EVSettings.System.getIntForUser(
                        resolver, EVSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN,
                        LedValues.LIGHT_BRIGHTNESS_MAXIMUM, UserHandle.USER_CURRENT);
            }

            mZenAllowLights = EVSettings.System.getIntForUser(resolver,
                        EVSettings.System.ZEN_ALLOW_LIGHTS,
                        1, UserHandle.USER_CURRENT) != 0;
