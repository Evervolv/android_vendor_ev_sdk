...
public class PartsList {
    ...
    public static final String ACTION_REFRESH_PART = "com.evervolv.parts.REFRESH_PART";
    ...
    public static  final ComponentName PARTS_REFRESHER = new ComponentName(
            PARTS_PACKAGE, PARTS_PACKAGE + ".RefreshReceiver");
    ...
    public void registerRemotePart(final String key, final PartInfo.RemotePart remote) {
        synchronized (mParts) {
            ...
            i.setComponent(PartsList.PARTS_REFRESHER);
