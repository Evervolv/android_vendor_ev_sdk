...
import evervolv.power.IPerformanceManager;
import evervolv.power.PerformanceManagerInternal;
import evervolv.power.PerformanceProfile;

import static evervolv.power.PerformanceManager.PROFILE_BALANCED;
import static evervolv.power.PerformanceManager.PROFILE_HIGH_PERFORMANCE;
import static evervolv.power.PerformanceManager.PROFILE_POWER_SAVE;
import static evervolv.provider.EVSettings.Secure.APP_PERFORMANCE_PROFILES_ENABLED;
import static evervolv.provider.EVSettings.Secure.PERFORMANCE_PROFILE;
import static evervolv.provider.EVSettings.Secure.getInt;
import static evervolv.provider.EVSettings.Secure.getUriFor;
import static evervolv.provider.EVSettings.Secure.putInt;

/**
 * @hide
 */
public class PerformanceManagerService extends VendorService {
    ...
    public String getFeatureDeclaration() {
        return ContextConstants.Features.PERFORMANCE;
    }

    @Override
    public void onStart() {
        publishBinderService(ContextConstants.PERFORMANCE_SERVICE, mBinder);
    ...
    private boolean setPowerProfileLocked(int profile, boolean fromUser) {
        ...
        mContext.enforceCallingOrSelfPermission(
                evervolv.platform.Manifest.permission.PERFORMANCE_ACCESS, null);
