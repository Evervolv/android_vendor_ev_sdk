...
public class ChargingControlController extends VendorHealthFeature {
    ...
    private final Uri MODE_URI = EVSettings.System.getUriFor(
            EVSettings.System.CHARGING_CONTROL_MODE);
    private final Uri LIMIT_URI = EVSettings.System.getUriFor(
            EVSettings.System.CHARGING_CONTROL_LIMIT);
    private final Uri ENABLED_URI = EVSettings.System.getUriFor(
            EVSettings.System.CHARGING_CONTROL_ENABLED);
    private final Uri START_TIME_URI = EVSettings.System.getUriFor(
            EVSettings.System.CHARGING_CONTROL_START_TIME);
    private final Uri TARGET_TIME_URI = EVSettings.System.getUriFor(
            EVSettings.System.CHARGING_CONTROL_TARGET_TIME);
    ...
    public boolean setEnabled(boolean enabled) {
        putBoolean(EVSettings.System.CHARGING_CONTROL_ENABLED, enabled);
        return true;
    }
    ...
    public boolean setMode(int mode) {
        ...
        putInt(EVSettings.System.CHARGING_CONTROL_MODE, mode);
        return true;
    }
    ...
    public boolean setStartTime(int time) {
        ...
        putInt(EVSettings.System.CHARGING_CONTROL_START_TIME, time);
        return true;
    }
    ...
    public boolean setTargetTime(int time) {
        ...
        putInt(EVSettings.System.CHARGING_CONTROL_TARGET_TIME, time);
        return true;
    }
    ...
    public boolean setLimit(int limit) {
        ...
        putInt(EVSettings.System.CHARGING_CONTROL_LIMIT, limit);
        return true;
    }
    ...
    private boolean shouldSetLimitFlag() {
        ...
        if (!mIsChargingBypassSupported
                ...
                && mBatteryPct < mConfigLimit - mChargingLimitMargin) {
            return false;
        }
    ...
    private void handleSettingChange() {
        mConfigEnabled = EVSettings.System.getInt(mContentResolver,
                EVSettings.System.CHARGING_CONTROL_ENABLED, 0)
                != 0;
        mConfigLimit = EVSettings.System.getInt(mContentResolver,
                EVSettings.System.CHARGING_CONTROL_LIMIT,
                mDefaultLimit);
        mConfigMode = EVSettings.System.getInt(mContentResolver,
                EVSettings.System.CHARGING_CONTROL_MODE,
                mDefaultMode);
        mConfigStartTime = EVSettings.System.getInt(mContentResolver,
                EVSettings.System.CHARGING_CONTROL_START_TIME,
                mDefaultStartTime);
        mConfigTargetTime = EVSettings.System.getInt(mContentResolver,
                EVSettings.System.CHARGING_CONTROL_TARGET_TIME,
                mDefaultTargetTime);
    ...
    class ChargingControlNotification {
        ...
        private static final String ACTION_CHARGING_CONTROL_CANCEL_ONCE =
                "evervolv.intent.action.CHARGING_CONTROL_CANCEL_ONCE";
