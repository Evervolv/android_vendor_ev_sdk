...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mDefaultNightTemperature = mContext.getResources().getInteger(
                com.evervolv.platform.internal.R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        com.evervolv.platform.internal.R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        com.evervolv.platform.internal.R.integer.config_maxColorTemperature));

        mColorBalanceCurve = com.evervolv.internal.util.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.evervolv.internal.util.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(EVSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(EVSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(EVSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(EVSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
