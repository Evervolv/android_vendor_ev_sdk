...
public abstract class VendorBaseFeature {
    protected final Context mContext;
    protected final Handler mHandler;
    protected SettingsObserver mSettingsObserver;

    public VendorBaseFeature(Context context, Handler handler) {
        mContext = context;
        mHandler = handler;
    }
    ...
    protected final String getString(String setting) {
        return EVSettings.System.getStringForUser(mContext.getContentResolver(),
