...
public abstract class ChargingControlProvider {
    ...
    /**
     * Called when the mode is {@link evervolv.health.HealthInterface#MODE_LIMIT} and
    ...
    /**
     * Called when the mode is {@link evervolv.health.HealthInterface#MODE_AUTO} or
     * {@link evervolv.health.HealthInterface#MODE_MANUAL} and the
     ...
     *                   {@link evervolv.health.HealthInterface#MODE_AUTO} or
